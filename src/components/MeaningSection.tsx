   ...
   return (
      <>
         <div className='flex italic items-center mt-7'>
            <div className='text-2xl font-bold text-neutral-900'>{meaning.partOfSpeech}</div>
            <div className='h-[0.3px] w-full bg-neutral-200'></div>
         </div>
         <div className='text-sm font-semibold text-neutral-400 italic flex justify-end'>Examples</div>
         <ul className='ml-10'>
